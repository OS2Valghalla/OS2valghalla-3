...
namespace Valghalla.Internal.Infrastructure.Modules.Administration.WorkLocationTemplate
{
    ...
    internal class WorkLocationTemplateListingQueryRepository : QueryEngineRepository<WorkLocationTemplateListingQueryForm, WorkLocationTemplateResponse, WorkLocationTemplateListingQueryFormParameters, WorkLocationTemplateEntity>
    {
        private readonly IMapper mapper;

        public WorkLocationTemplateListingQueryRepository(DataContext dataContext, IMapper mapper) : base(dataContext, mapper)
        {
            this.mapper = mapper;
        ...
        public override async Task<QueryResult<WorkLocationTemplateResponse>> ExecuteQuery(WorkLocationTemplateListingQueryForm form, CancellationToken cancellationToken)
        {
            ...
            return new QueryResult<WorkLocationTemplateResponse>(keys, items);
        }
    }
}
