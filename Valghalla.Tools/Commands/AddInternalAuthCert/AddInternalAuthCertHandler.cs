...
{
    internal class AddInternalAuthCertHandler
    {
        public IConfiguration Config { get; set; }
        private static readonly Guid _identifier = Application.Constants.FileStorage.InternalAuthCertificate;
        private static readonly string _filename = "InternalAuthCert";
        public AddInternalAuthCertHandler(IConfiguration Config)
        {
            this.Config = Config;
        }

        public void AddInternalAuthCert(string databaseName, string filePath, string password)
        {
            ...
            AddInternalCertificate(connection, cert);
        ...
        private static void AddInternalCertificate(string connection, byte[] cert)
        {
