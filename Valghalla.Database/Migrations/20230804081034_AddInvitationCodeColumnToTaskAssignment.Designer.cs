...
namespace Valghalla.Database.Migrations
{
    ...
    [Migration("20230804081034_AddInvitationCodeColumnToTaskAssignment")]
    partial class AddInvitationCodeColumnToTaskAssignment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.ParticipantEntity", b =>
                {
                    ...
                    b.Property<string>("MunicipalityCvr")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .UseCollation("da-DK-x-icu");
