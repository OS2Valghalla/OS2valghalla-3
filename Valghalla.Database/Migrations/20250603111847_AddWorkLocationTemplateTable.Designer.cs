...
namespace Valghalla.Database.Migrations
{
    ...
    [Migration("20250603111847_AddWorkLocationTemplateTable")]
    partial class AddWorkLocationTemplateTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.AuditLogEntity", b =>
                {
                    ...
                    b.HasIndex(new[] { "Pk2value" }, "IX_AuditLog_Clustered");
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.ElectionEntity", b =>
                {
                    ...
                    b.Property<Guid?>("WorkLocationTemplateEntityId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkLocationTemplateEntityId");
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.FileEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.ParticipantEntity", b =>
                {
                    ...
                    b.Property<bool>("ProtectedAddress")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.TaskAssignmentEntity", b =>
                {
                    ...
                    b.Property<bool>("RegistrationSent")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.WorkLocationTemplateEntity", b =>
                {
                    ...
                    b.ToTable("WorkLocationTemplates");
                });
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.AuditLogEntity", b =>
                {
                    b.HasOne("Valghalla.Database.Entities.Tables.UserEntity", "DoneByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.ElectionEntity", b =>
                {
                    ...
                    b.HasOne("Valghalla.Database.Entities.Tables.WorkLocationTemplateEntity", null)
                        .WithMany("Elections")
                        .HasForeignKey("WorkLocationTemplateEntityId");
            ...
            modelBuilder.Entity("Valghalla.Database.Entities.Tables.FileReferenceEntity", b =>
                {
                    ...
                    b.HasOne("Valghalla.Database.Entities.Tables.FileEntity", null)
                        .WithOne("FileReference")
                        .HasForeignKey("Valghalla.Database.Entities.Tables.FileReferenceEntity", "FileId");
