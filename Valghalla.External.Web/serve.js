...
const appSettingsPath = join(process.cwd(), "../Valghalla.External.API/appsettings.development.json");
...
const appSettings = require('../Valghalla.External.API/appsettings.development.json');
...
console.log(`Valghalla.External.Web Server: ${appSettings.AngularDevServer}`);
console.log(`Valghalla.External.API Server: ${appSettings.Urls}`);
